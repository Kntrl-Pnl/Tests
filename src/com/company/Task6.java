...
public class Task6 {
    ...
    public static void main(String[] msi) {
        out.println(bell(1));
        out.println(translateWord("flag"));
        out.println(translateSentence("I like to eat honey waffles."));
        out.println(validColor("rgb(0,,0)"));
        out.println(stripUrlParams("https://edabit.com?a=1&b=2&a=2"));
        out.println(getHashTags("How the Avocado Became the Fruit of the Global Trade"));
        out.println(ulam(200));
        out.println(longestNonrepeatingSubstring("abcabcbb"));
        out.println(convertToRoman(404));
        out.println(formula("6 * 4 = 404"));

...
public class Task5 {
    public static void main(String[] msi) throws NoSuchAlgorithmException {
        out.println(encrypt("Hello"));
        //out.println(decrypt();
        out.println(canMove("Rook", "A8", "H8"));
        out.println(canComplete("butl", "beautiful"));
        out.println(sumDigProd(16, 28));
        out.println(sameVowelGroup("toe", "ocelot", "maniac"));
        out.println(validateCard(123456789));
        out.println(numToEng(404));
        out.println(getSha256Hash("pass"));
        out.println(correctTitle("jOn SnoW, kINg IN thE noRth."));
